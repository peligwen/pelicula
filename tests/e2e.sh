...
" 2>/dev/null; then
    ...
    # instead of --skip-auth — this unlocks the 7 authenticated suites
    # (bug1-reconcile, bug4-registration, sweep-catalog/jobs/users/settings,
    # sweep-search-options, sweep-remove-action) instead of silently skipping
    # them. PELICULA_ENV_FILE, exported in
