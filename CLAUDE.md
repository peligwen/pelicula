...
- `cmd/pelicula/` — Go CLI binary (cross-platform: macOS/Linux/Windows/Synology), stdlib-only
...
```
pelicula setup               # browser-based setup wizard, generates .env
pelicula up                  # migrate .env, seed configs, start stack, wait for VPN, print URLs
